...
public class ListOfIllustrationsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_of_illustrations);

        context = this;
        back = (Button) findViewById(R.id.backToBookView3);
        ...
        // TODO:......
        final ListView itmes = (ListView) findViewById(R.id.listOfIllustrations);

        // TODO:Add itmes to array.....
        String[] metadata_values = new String[] { "illustrations 1", "illustrations 2" };
